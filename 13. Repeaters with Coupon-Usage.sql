...
delete from KPIsByDay where KPIName = 'Repeaters with Coupon-Usage';
delete from KPIsByCalendarWeek where KPIName = 'Repeaters with Coupon-Usage';
delete from KPIsByMonth where KPIName = 'Repeaters with Coupon-Usage';
...
select 'Repeaters with Coupon-Usage' as KPIName 
	  ,KPI_DAY
